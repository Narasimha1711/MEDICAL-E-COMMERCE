    ...
    <div className="sidebar">
      ...
      <div className="center">
        <ul className="nav-list">
          ...
          <p className="title">B2B</p>
          <Link
            to="/seller-b2b"
            onClick={() => handleLinkClick("/seller-b2b")}
            className="nav-link"
          >
            <li className={`nav-item ${activeLink === "/seller-b2b" ? "active" : ""}`}>
              <Pill className="icon" style={{color: '#007bff'}} />
              <span>Buy/Sell Medicines (B2B)</span>
            </li>
          </Link>
